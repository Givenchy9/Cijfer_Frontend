    ...
    <header class="bg-darkblue">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8" aria-label="Global">
            ...
            <!-- <PopoverGroup class="hidden lg:flex lg:gap-x-12">
                <RouterLink to="/profiel" class="text-sm/6 font-semibold text-gray-900">Profiel</RouterLink>
                <RouterLink to="/ouders" class="text-sm/6 font-semibold text-gray-900">Ouders</RouterLink>
                <RouterLink to="/thema" class="text-sm/6 font-semibold text-gray-900">Thema</RouterLink>
            </PopoverGroup> -->
            <div class="hidden lg:flex lg:flex-1 lg:justify-end">
                <RouterLink to="/dashboard" class="text-sm/6 font-semibold text-gray-900">Go back <span
